            ...
            <div class="row d-flex align-items-center justify-content-center">
                <div class="about-content col-lg-12">
                    ...
                    <p class="text-white link-nav"><a href="\">Home </a> <span class="lnr lnr-arrow-right"></span> <a
                            href="/product_listing"> Vehicle </a> <span class="lnr lnr-arrow-right"></span> <a
                            href="/vehicle_rent"> Vehicle rent List</a></p>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="gp_products_item_caption">
                    ...
                    <ul class="gp_products_caption_rating mt-2">
                        <li class="___class_+?39___"><a class="___class_+?40___"
                                href="product_listing_detail/{{ $vehicle->id }}">book now</a></li>
