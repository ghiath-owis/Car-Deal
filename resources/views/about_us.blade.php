...
@section('content')
			...
			<!-- Start service Area -->
			<section class="service-area section-full" id="service">
				<div class="container">
					...
					<div class="row">
						<div class="col-lg-4 col-md-6 col-sm-6">
							<div class="single-service">
								<h4><span class="lnr lnr-user"></span>Expert Car Dealer</h4>
								<p>
						...
						<div class="col-lg-4 col-md-6 col-sm-6">
							<div class="single-service">
								<h4><span class="lnr lnr-license"></span>Official Paper Work</h4>
								<p>
									Usage of the Internet is becoming more common due to rapid advancement of technology and power.
								</p>								
							</div>
						...
						<div class="col-lg-4 col-md-6 col-sm-6">
							<div class="single-service">
								<h4><span class="lnr lnr-heart-pulse"></span>Best Price</h4>
								<p>
									Usage of the Internet is becoming more common due to rapid advancement of technology and power.
								</p>								
							</div>
						...
						<div class="col-lg-4 col-md-6 col-sm-6">
							<div class="single-service">
								<h4><span class="lnr lnr-rocket"></span>Big Collection</h4>
								<p>
									Usage of the Internet is becoming more common due to rapid advancement of technology and power.
								</p>				
							</div>
						...
						<div class="col-lg-4 col-md-6 col-sm-6">
							<div class="single-service">
								<h4><span class="lnr lnr-bubble"></span>Positive User Reviews</h4>
								<p>
									Usage of the Internet is becoming more common due to rapid advancement of technology and power.
								</p>									
							</div>
			...
			<section class="callto-action-area section-full">
				<div class="container">
					<div class="row d-flex justify-content-center">
			...
			<!-- Start team Area -->
			<section class="team-area section-full" id="team">
				<div class="container">
					<div class="row d-flex justify-content-center">
