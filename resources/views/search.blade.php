				...
				<div class="container">
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="\">Home </a>  <span class="lnr lnr-arrow-right"></span> <a href="javascript:void(0);"> Search Result </a> 
						</div>											
					</div>
				</div>
			</section>
					...
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-40 col-lg-10">
							<div class="title text-center">
								<h1 class="mb-10">Your Search Result</h1>
								<hr class="lines">
							</div>
						</div>
					</div>
