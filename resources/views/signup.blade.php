...
<html lang="en">
<head>
	<title>HartsFord - Sign Up Buy & Sell Market Place</title>
	<meta charset="UTF-8">
			...
			<div class="wrap-login100 ">
				<form class="login100-form validate-form">
					...
					<div class="wrap-input100 validate-input m-b-16" data-validate = "Valid email is required: johnny">
						<input class="input100" type="text" name="text" placeholder="First Name">
					...
					<div class="wrap-input100 validate-input m-b-16" data-validate = "Valid email is required: english">
						<input class="input100" type="text" name="text" placeholder="Last Name">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
							<span class="lnr lnr-user"></span>
						</span>
