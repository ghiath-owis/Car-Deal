...
@section('content')
			...
			<section class="blog-posts-area section-gap">
				<div class="container">
					<div class="row">
						<div class="col-lg-8 post-list blog-post-list order-sm-2">
							...
							<div class="single-post">
								<img class="img-fluid" src="img/featured/pic5.jpg" alt="">
								<ul class="tags">
								...
								<a href="blog-single.html">
									<h3 class="mt-20 mb-20">
										Time To Ride For A Adventurous Holiday
									</h3>
								</a>
									<p>
										You will begin to realize why this exercise is called the Dickens Pattern with reference to the ghost showing Scrooge some different futures as you notice that the idea of this exercise is to hypnotize yourself to be aware of two very real possibilities for your future. Two distinct pathways that you could take for your life this very day. Have a think about something that you do that you are maybe not motivated.
							...
							<div class="single-post">
								<img class="img-fluid" src="img/featured/about1.jpg" alt="">
								<ul class="tags">
							...
							<div class="single-post">
								<img class="img-fluid" src="img/blog/bheader3.jpg" alt="">
								<ul class="tags">
									<li><a href="#">Sports Car, </a></li>
									<li><a href="#">Motot Car, </a></li>
									<li><a href="#">Dealer</a></li>
								</ul>
								<a href="blog-single.html">
									<h3 class="mt-20 mb-20">
										Meet The Best Car Of The Year
									</h3>
								</a>
									<p>
										You will begin to realize why this exercise is called the Dickens Pattern with reference to the ghost showing Scrooge some different futures as you notice that the idea of this exercise is to hypnotize yourself to be aware of two very real possibilities for your future. Two distinct pathways that you could take for your life this very day. Have a think about something that you do that you are maybe not motivated.
						...
						<div class="col-lg-4 sidebar order-sm-1">
									...
									<div class="col-lg-12 col-md-12 col-sm-12 mt-30">
										<nav aria-label="...">
										  <ul class="pagination justify-content-center">
										    ...
										    <li class="page-item text-white active"><a class="page-link" href="#">1</a></li>
